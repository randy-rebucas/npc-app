                ...
                <div className="space-y-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">Get paired with a collaborating physician instantly, so you can start your practice without delay.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="font-semibold mb-2">Significant Savings:</h3>
                            <p className="text-gray-600">Our service is 30% more affordable than competitors, providing you with top-tier support at a lower cost.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">From legal agreements and included physician malpractice insurance, we handle it all, ensuring you are fully compliant with state regulations.</p>
                        </div>
                    </div>
                </div>

                <button className="mt-12 px-6 py-3 bg-white border-2 border-gray-200 rounded-full font-semibold hover:bg-gray-50 transition-colors">
