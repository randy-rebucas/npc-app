        ...
        <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white p-6 space-y-6">
                ...
                <div className="space-y-4">
                    {/* Contact Card */}
                    <Link href="/np/help/contact" className="group flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-blue-500 transition-all cursor-pointer hover:shadow-lg hover:shadow-blue-50">
                        <div>
                    ...
                    {/* Report Issue Card */}
                    <Link href="/np/help/report" className="group flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-red-500 transition-all cursor-pointer hover:shadow-lg hover:shadow-red-50">
                        <div>
                    ...
                    <Link href="/np/help/feature" className="group flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-green-500 transition-all cursor-pointer hover:shadow-lg hover:shadow-green-50">
                        <div>
