    ...
    return (
        <SidebarInset>
            <AdminHeader breadcrumbs={[
                ...
                { label: 'Permissions', href: '/admin/dashboard/permissions', active: true },
            ]} />
            ...
            <div className="flex flex-1 flex-col gap-4 p-4">
                <div className="mx-auto w-full space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <Button asChild>
                            <Link href="/admin/dashboard/permissions/new" className="flex items-center gap-2">
                                        ...
                                        return (
                                            <TableRow key={permission._id}>
                                                ...
                                                <TableCell className="flex items-center justify-end gap-2 p-3">
                                                    <Link href={`/admin/dashboard/permissions/${permission._id}`}>
