            ...
            <div className="flex flex-1 flex-col gap-4 p-4">
                <div className="mx-auto w-full space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Filter target="status" options={[{ 'PENDING': 'Pending' }, { 'ACCEPTED': 'Accepted' }, { 'DECLINED': 'Declined' }, { 'EXPIRED': 'Expired' }, { 'CANCELLED': 'Cancelled' }, { 'WITHDRAWN': 'Withdrawn' }]} placeholder="Status" defaultValue="all" />
                    </div>
